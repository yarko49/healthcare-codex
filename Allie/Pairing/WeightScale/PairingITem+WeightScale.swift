...
extension PairingItem {
	static var weightScaleItems: [PairingItem] = [PairingItem(id: "one", imageName: "", title: NSLocalizedString("BT_STEP_ONE.title", comment: "Step 1."), message: NSLocalizedString("BPM_STEP_ONE.message", comment: "Step 1 Message")),
