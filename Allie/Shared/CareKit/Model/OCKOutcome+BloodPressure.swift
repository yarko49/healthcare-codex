...
extension OCKAnyOutcome {
    ...
    var valuesCountPerRecord: Int {
        ...
        if quantityIdentifier == HKQuantityTypeIdentifier.bloodPressureSystolic.rawValue ||
            quantityIdentifier == HKQuantityTypeIdentifier.bloodPressureDiastolic.rawValue {
            return 2
        }
        return 1
    }
    var recordsCount: Int {
        return values.count / valuesCountPerRecord
    }
