...
class ProfileEntryViewController: UICollectionViewController {
	override func viewDidLoad() {
		super.viewDidLoad()
		// Register cell classes
		collectionView?.register(TextFieldEntryCell.self, forCellWithReuseIdentifier: TextFieldEntryCell.reuseIdentifier)
