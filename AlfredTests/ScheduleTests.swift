...
class ScheduleTests: XCTestCase {
	...
	override func setUpWithError() throws {
		...
		testData = AlfredHealthTests.loadTestData(fileName: "SechduleA.json")
	...
	func testScheduleA() throws {
		...
		let endDate = AlfredHealthTests.wholeDateNoTimeZoneRequest.date(from: "2999-11-11T01:31:00Z")
