...
enum GATTCharacteristicType: Int, GATTIdentifiableType {
...
extension GATTCharacteristicType {
...
extension GATTCharacteristicType {
	static var deviceInfo: Set<GATTCharacteristicType> {
	...
	static var bloodGlucoseMeasurements: Set<GATTCharacteristicType> {
		[.bloodGlucoseMeasurement, .bloodGlucoseMeasurementContext, .recordAccessControlPoint]
	}

	static var bloodPressureMeasurements: Set<GATTCharacteristicType> {
