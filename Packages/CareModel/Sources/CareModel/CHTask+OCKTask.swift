...
public protocol AnyTaskExtensible: AnyUserInfoExtensible {
...
public extension AnyTaskExtensible {
	var priority: Int {
		get {
...
public extension AnyTaskExtensible where Self: OCKAnyTask {
