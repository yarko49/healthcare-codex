...
public struct CHSource: Codable, Equatable {
	public let name: String
	public let bundleIdentifier: String
}

public extension CHSource {
...
public struct CHSourceRevision: Codable, Equatable {
	public let source: CHSource?
	public let version: String?
	public let productType: String?
	public let operationSystemVersion: OperatingSystemVersion

	public static func == (lhs: CHSourceRevision, rhs: CHSourceRevision) -> Bool {
		lhs.source == rhs.source && lhs.version == rhs.version && lhs.productType == rhs.productType && lhs.operationSystemVersion == rhs.operationSystemVersion
	}
}
