...
public class ObservationFactory: BaseFactory, ResourceFactoryProtocol {
	...
	public func observation(from object: HKObject) throws -> ModelsR4.Observation {
		...
		let effective = try effective(sample: sample)
	...
	public func observation(from values: [Double], identifier: String, date: Date) throws -> ModelsR4.Observation {
	...
	public func codeableConcept(objectType: HKObjectType) throws -> ModelsR4.CodeableConcept {
	...
	public func valueQuantity(sample: HKQuantitySample) throws -> ModelsR4.Quantity {
	...
	public func valueQuantity(value: Double, identifier: String) throws -> ModelsR4.Quantity {
	...
	public func component(correlation: HKCorrelation) throws -> [ModelsR4.ObservationComponent] {
		var components: [ModelsR4.ObservationComponent] = []

		for sample in correlation.objects {
			if let quantitySample = sample as? HKQuantitySample {
				let codeableConcept = try codeableConcept(objectType: quantitySample.sampleType)
	...
	public func component(values: [Double], identifier: String) throws -> [ModelsR4.ObservationComponent] {
		guard !values.isEmpty else {
			throw ConversionError.requiredConversionValueMissing(key: identifier)
		}
	...
	public func effective(sample: HKSample) throws -> Any {
	...
	public var configuarion: ObservationsConfig
