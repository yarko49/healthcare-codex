...
public struct AKBloodGlucoseRecord: Identifiable, Hashable {
	...
	public init(sequence: Int, utcTimestamp: Date, timezoneOffsetInSeconds: Int, glucoseConcentration: Double, concentrationUnit: AKBloodGlucoseConcentrationUnit, sampleType: String, sampleLocation: String, sensorFlags: AKSensorFlags, mealContext: String, mealTime: AKBloodGlucoseMealTime, peripheral: CBPeripheral?, measurementData: Data, contextData: Data?) {
...
public extension AKBloodGlucoseRecord {
	init(reading: AKBloodGlucoseReading) {
...
public extension AKBloodGlucoseRecord {
	init(measurement: [Int], context: [Int], peripheral: CBPeripheral?, measurementData: Data, contextData: Data?) {
		self.init(reading: AKBloodGlucoseReading(measurement: measurement, context: context, peripheral: peripheral, measurementData: measurementData, contextData: contextData))
	}
}
