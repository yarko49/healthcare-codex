...
public enum AKBloodGlucoseMealTime: Int, Hashable, CaseIterable {
	case unknown
	case preprandial
	case postprandial
	case fasting
...
extension AKBloodGlucoseMealTime: CustomStringConvertible {
...
public extension AKBloodGlucoseMealTime {
	var kind: String {
