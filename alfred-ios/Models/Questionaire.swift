...
<<<<<<< HEAD
=======
>>>>>>> Add selection, fix minor issues related to the questionnaire
...
<<<<<<< HEAD
=======
>>>>>>> Add JSON mock data for Questionaire, split questions, fix bugs related to width and height of questions
=======
>>>>>>> Add selection, fix minor issues related to the questionnaire
