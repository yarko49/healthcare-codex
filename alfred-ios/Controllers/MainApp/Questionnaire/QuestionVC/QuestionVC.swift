...
class QuestionVC: BaseVC {
    ...
    var closeAction: (()->())?
    var getQuestionnaireAction: (()->())?
    var nextQuestionAction: (()->())?
    var onQuestionPartAnsweredAction: ((String, String)->())?
    ...
    @IBOutlet weak var nextQuestionBtn: RoundedButton!
    @IBOutlet weak var multiPartQuestionsSV: UIStackView!
    @IBOutlet weak var scrollView: UIScrollView!
    @IBOutlet weak var stackViewCenterXConstraint: NSLayoutConstraint!
    @IBOutlet weak var questionHeightContraint: NSLayoutConstraint!
    ...
    override func setupView() {
        ...
        self.view.layer.backgroundColor = UIColor.lightBackground?.cgColor
        self.continueViewBottomConstraint.constant = -continueView.frame.height
